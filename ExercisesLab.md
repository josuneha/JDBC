...
Review the following files ([ProductData.java] (ProductData.java) and [ProductDataTest.java] (ProductDataTest.java)) to understand how they work and the results we get if we execute them using different parameters. 
